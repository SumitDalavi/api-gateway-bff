...
## The Problem
## Problem Statement
Frontend applications often suffer from over-fetching or multiple disparate API calls, leading to slow rendering times and high network overhead.
...
## 🛠️ Tech Stack
- **Core Technology**: Node.js, Express, Redis
...
git clone https://github.com/SumitDalavi/api-gateway-bff.git
cd api-gateway-bff
...
- **Throughput/Latency:** P99 < 15ms (Cache Hits)
...
- Token aggregation layer relies on downstream JWT validation.
...
- **Mocked / Demo Mode:** Downstream API calls are explicitly tested using an embedded HTTP server fixture.
